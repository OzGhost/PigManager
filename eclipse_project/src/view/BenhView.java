...
public class BenhView extends ViewBase
{
	...
	public BenhView() {
		...
		Layer.put(txtLoaiBenh).in(sl_panelMidLeft).atLeft(panelMidLeft).withMargin(100).atTop(lblLoaiBenh)
				.withMargin(0);
		...
		Layer.put(txtTrieuChung).in(sl_panelMidRight).atLeft(panelMidRight).withMargin(120).atTop(lblTrieuChung)
				.withMargin(0).atBottom(panelMidRight).withMargin(10).atRight(panelMidRight).withMargin(10);

		JScrollPane scrollNgayTao = new JScrollPane(txtTrieuChung, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
		...
		JScrollPane scrolltbBenh = new JScrollPane(tbBenh, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
				JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
