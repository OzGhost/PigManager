...
public class ProviderManagerView extends ViewBase
{
	...
	public ProviderManagerView() {
		...
		// Chon NCC
		Layer.put(_lblMaNCC).in(sl_panelMidLeft).atTop(_panelMidLeft).withMargin(5).atLeft(_panelMidLeft)
				.withMargin(70);
		Layer.put(_lblTenNCC).in(sl_panelMidLeft).bottomOf(_txtfMaNCC).withMargin(10).atLeft(_panelMidLeft)
				.withMargin(70);
		Layer.put(_lblSDT).in(sl_panelMidLeft).bottomOf(_txtfTenNCC).withMargin(10).atLeft(_panelMidLeft)
				.withMargin(70);
		...
		Layer.put(_txtfMaNCC).in(sl_panelMidLeft).atTop(_panelMidLeft).withMargin(5).atLeft(_panelMidLeft)
				.withMargin(180);
		Layer.put(_txtfTenNCC).in(sl_panelMidLeft).atLeft(_panelMidLeft).withMargin(180).bottomOf(_txtfMaNCC)
				.withMargin(10);
		Layer.put(_txtfSDT).in(sl_panelMidLeft).atLeft(_panelMidLeft).withMargin(180).bottomOf(_txtfTenNCC)
				.withMargin(10);
		Layer.put(_txtfDiaChi).in(sl_panelMidLeft).atLeft(_panelMidLeft).withMargin(180).bottomOf(_txtfSDT)
				.withMargin(10);
		Layer.put(_txtfNoPhaiTra).in(sl_panelMidLeft).atLeft(_panelMidLeft).withMargin(180).bottomOf(_txtfDiaChi)
				.withMargin(10);
		...
		Layer.put(_scrollMoTa).in(sl_panelMidRight).atTopRight(_panelMidRight).withMargin(10).atBottom(_panelMidRight)
				.withMargin(10);

		Layer.put(_lblMoTa).in(sl_panelMidRight).rightOf(_scrollMoTa).withMargin(10).atTop(_panelMidRight)
				.withMargin(10);
		...
		Layer.put(_panelTop).in(sl_contentpane).atTop(contentpane).withMargin(30).atLeft(contentpane).withMargin(200)
				.atRight(contentpane).withMargin(200);
		Layer.put(_panelMidLeft).in(sl_contentpane).bottomOf(_panelTop).withMargin(20).atLeft(contentpane)
				.withMargin(50);
		sl_contentpane.putConstraint(SpringLayout.SOUTH, _panelMidRight, 0, SpringLayout.SOUTH, _panelMidLeft);
		Layer.put(_panelMidRight).in(sl_contentpane).bottomOf(_panelTop).withMargin(20).atRight(contentpane)
		...
		Layer.put(_btnXoa).in(sl_contentpane).atBottom(contentpane).withMargin(5).leftOf(_btnThem).withMargin(150)
				.bottomOf(_panelBot).withMargin(5);
		Layer.put(_btnSua).in(sl_contentpane).atBottom(contentpane).withMargin(5).leftOf(_btnXoa).withMargin(150)
				.bottomOf(_panelBot).withMargin(5);
