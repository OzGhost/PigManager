...
public class ChonThuocView extends ViewBase{
	...
	public ChonThuocView(){
      ...
      //set panelBot
        ...
        final String[] columnChonThuoc={"Mã thuốc","Tên thuốc","Thành phần"};
        ...
        JScrollPane scrolltbBenh = new JScrollPane(tbChonThuoc, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        ...
        Layer.put(btnChonThuoc).in(sl_panelMain).leftOf(panelBot).withMargin(20).bottomOf(panelTop).withMargin(80).atRight(panelMain).withMargin(20);
